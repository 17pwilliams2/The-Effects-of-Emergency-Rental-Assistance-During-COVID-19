...
foreach year of numlist 1975/2019 {
    ...
    keep id dweght princ flemp flsup flwag flmil flprl fkinc fkhou fkequ ///
        ...
        fiinc xkidspop married age female ssuicontrib uiinc filer potax salestax
...
compress
save "01-import-dina/dina-full.dta", replace
...
use "01-import-dina/dina-full.dta", clear
...
save "01-import-dina/dina-full-aggregates.dta", replace
