...
foreach income in princ peinc dispo poinc hweal {
    foreach pop in working_age {
        quietly {
            clear
            save "03-decompose-components/decomposition-monthly-`income'-`pop'.dta", replace emptyok
            foreach t of numlist $date_begin / $date_end {
                ...
                use "03-build-monthly-microfiles/microfiles/dina-monthly-`year'm`month'.dta", clear
                ...
                append using "03-decompose-components/decomposition-monthly-`income'-`pop'.dta"
                save "03-decompose-components/decomposition-monthly-`income'-`pop'.dta", replace
            }
            
            use "03-decompose-components/decomposition-monthly-`income'-`pop'.dta", clear
            
            merge n:1 year month using "02-prepare-nipa/nipa-simplified-monthly.dta", nogenerate keepusing(nipa_deflator)
